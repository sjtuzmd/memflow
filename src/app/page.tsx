    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          {currentStep === 2 && (
            <div className="p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Organize Your Photos</h2>
              <p className="text-gray-600 mb-6">This is where you can organize your uploaded photos.</p>
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <p className="text-gray-500 text-center">Organization features coming soon!</p>
              </div>
            </div>
          )}
          ...
          {currentStep === 3 && (
            <div className="p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Export Your Photos</h2>
              <p className="text-gray-600 mb-6">Export your organized photos in your preferred format.</p>
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <p className="text-gray-500 text-center">Export features coming soon!</p>
              </div>
            </div>
          )}
